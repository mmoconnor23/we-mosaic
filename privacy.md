...
we-mosaic ("us", "we", or "our") operates the we-mosaic.factset.io website
(the "Service").

This page informs you of our policies regarding the collection, use, and
disclosure of personal data when you use our Service and the choices you have
associated with that data. This Privacy Policy for we-mosaic is powered by
...
we-mosaic uses the collected data for various purposes:
...
we-mosaic will take all steps reasonably necessary to ensure that your data is
...
we-mosaic may disclose your Personal Data in the good faith belief that such
action is necessary to:

  * To comply with a legal obligation
  * To protect and defend the rights or property of we-mosaic
